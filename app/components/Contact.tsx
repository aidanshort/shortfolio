...
export default function ContactSection() {
  ...
  return (
    <ScrollFadeSection id="contact" className="z-10 scroll-mt-24 py-24">
      ...
      <div className="grid gap-10 md:grid-cols-2">
        <div className="space-y-6 rounded-2xl border border-slate-200 bg-white/70 p-8 shadow-sm">
          ...
          <div>
            ...
            <p className="mt-2 text-base text-slate-700">{location}</p>
          </div>
          <div>
        ...
        <form
          className="space-y-6 rounded-2xl border border-slate-200 bg-white/90 p-8 shadow-sm"
